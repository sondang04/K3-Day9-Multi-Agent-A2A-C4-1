...
- [ ] **B — Dương Mạnh Phongg** — Order/Seller + Delivery Agent
...
| 0.2 | Tạo `.gitignore` (`.env`, `__pycache__`, `*.pyc`) | A | [ ] |
| 0.3 | Khảo sát 9 CSV trong `data/`, ghi nhận schema quan trọng | A | [ ] |
| 0.4 | Tạo file `requirements.txt` (pandas, numpy, python-dotenv) | A | [ ] |
| 0.5 | Tạo `.env.example` (không có key thật) | A | [ ] |
| 0.6 | Tạo `config.py` chứa `MODEL_NAME` (vd `"qwen2.5:7b"`) | A | [ ] |
| 0.7 | Mỗi người tạo nhánh riêng: `feat/person-B`, `feat/person-C`, `feat/person-D` | A/B/C/D | [ ] |
